# com-chilipeppr-workspace-Rotorcraft1
A ChiliPeppr Workspace Rotorcraft1 for the laser camera.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / Rotorcraft1
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-Rotorcraft1 |
| Name                  | Workspace / Rotorcraft1 |
| Description           | A ChiliPeppr Workspace Rotorcraft1 for the laser camera. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/mlacarra/workspace-Rotorcraft1/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/mlacarra101/rotorcraft-lab |
| Github URL            | http://github.com/mlacarra/workspace-Rotorcraft1 |
| Test URL              | https://preview.c9users.io/mlacarra101/rotorcraft-lab/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/mlacarra/workspace-Rotorcraft1/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-Rotorcraft1"], // the id you gave your workspace
      function(myWorkspaceRotorcraft1) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / Rotorcraft1 just got loaded.", myWorkspaceRotorcraft1);
        myWorkspaceRotorcraft1.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-Rotorcraft1"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / Rotorcraft1"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace Rotorcraft1 for the laser camera."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/mlacarra/workspace-Rotorcraft1/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/mlacarra101/rotorcraft-lab"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/mlacarra/workspace-Rotorcraft1"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://rotorcraft-lab-mlacarra101.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
